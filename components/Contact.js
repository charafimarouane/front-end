...
const SvgContact = {
    ...
    Github : <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-github text-black/60 /50 dark:hover:text-secoundary hover:text-secoundary " viewBox="0 0 16 16">
